...
%endif
	...
	; Switch to protected mode with a far jump
	jmp	0x08:.2
.2:
	...
	; Load protected modetest data selector
	mov	ax, 0x20
	mov	es, ax
...
gdt_start:
	dw	0, 0, 0, 0
	dw	0xFFFF, 0x7C00, 0x9A00, 0x008F ; 16-bit code segment with full 4GiB limit and 0x00007C00 starting address
	dw	0xFFFF, 0x7C00, 0x9200, 0x008F ; data segment with full 4GiB limit and 0x00007C00 starting address
	dw	0xFFFF, 0x8000, 0x920B, 0x008F ; data segment with full 4GiB limit and 0x000B8000 starting address
