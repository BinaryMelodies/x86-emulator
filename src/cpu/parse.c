...
#define _x87_read32fp(seg, off) x87_convert32_to_float(emu, _x87_read32(seg, off))
#define _x87_read64fp(seg, off) x87_convert64_to_float(emu, _x87_read64(seg, off))
...
#define _x87_write32fp(seg, off, val, tag) _x87_write32(seg, off, x87_convert32_from_float(emu, val, tag))
#define _x87_write64fp(seg, off, val, tag) _x87_write64(seg, off, x87_convert64_from_float(emu, val, tag))
